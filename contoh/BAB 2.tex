...
\Textcite{johnsonCooperativeLearningReturns1998} mengembangkan teori cooperative learning yang berakar pada Social Interdependence Theory. Mereka menegaskan bahwa keberhasilan kelompok dalam mencapai tujuan bersama sangat bergantung pada tingkat saling ketergantungan positif (positive interdependence) di antara anggotanya. Model pembelajaran kooperatif ini menekankan lima elemen utama: saling ketergantungan positif, akuntabilitas individual, interaksi promotif tatap muka, keterampilan sosial, dan refleksi kelompok. Melalui interaksi tersebut, mahasiswa belajar untuk berkontribusi aktif, menghargai perbedaan, serta mengembangkan kemampuan komunikasi dan kepemimpinan.

Sementara itu, \Textcite{panhwarDifferentiatingCooperativeLearning2017} berpendapat bahwa collaborative learning merupakan bentuk percakapan sosial yang mendorong mahasiswa untuk membangun makna bersama (negotiated meaning) melalui diskusi dan refleksi. Ia menekankan bahwa pembelajaran kolaboratif menggeser paradigma tradisional dari transmisi pengetahuan menjadi konstruksi pengetahuan kolektif. Proses ini memungkinkan mahasiswa untuk tidak hanya memahami konsep, tetapi juga menginternalisasi nilai kerja sama, empati, dan tanggung jawab sosial.
...
Pendekatan Human-Centered Design (HCD) tidak hanya diterapkan dalam pengembangan produk teknologi, tetapi juga telah menjadi dasar transformasi dalam pendidikan tinggi. Menurut \Textcite{dasHumanCenteredDesignBasis}, penerapan prinsip HCD dalam kurikulum mampu mendorong mahasiswa untuk berpikir kreatif, empatik, dan reflektif terhadap masalah nyata yang dihadapi masyarakat. Melalui studi berjudul Human-Centered Design as a Basis for a Transformative Curriculum, mereka menekankan bahwa HCD memberikan kerangka pembelajaran yang menempatkan mahasiswa sebagai “co-creator” solusi, bukan sekadar penerima pengetahuan. Pendekatan ini menggeser paradigma pendidikan dari pembelajaran berbasis instruksi menjadi pembelajaran berbasis pengalaman dan empati terhadap pengguna akhir.

Lalu \Textcite{meinelDesignThinking2011} menjelaskan bahwa Design Thinking mendorong kerja kolaboratif multidisipliner yang menggabungkan empati, eksplorasi ide, dan eksperimen cepat sebagai bagian dari inovasi yang berpusat pada manusia (human-centered innovation). Pendekatan ini sangat relevan dalam konteks pengembangan platform kolaborasi mahasiswa, di mana kebutuhan pengguna sangat beragam—mulai dari pencarian partner, kepercayaan antar pengguna, hingga efisiensi komunikasi dalam tim.

\section{Platform Digital Kolaborasi Mahasiswa}
Penelitian di Indonesia menunjukkan bahwa kolaborasi digital di perguruan tinggi dapat meningkatkan efektivitas pembelajaran dan kompetensi kerja (Rahmawati et al., 2024). Namun, masih sedikit sistem yang memfasilitasi peer-to-peer matching antar-mahasiswa aktif. Kebanyakan platform yang ada seperti LinkedIn atau Riipen berorientasi profesional dan industri (EduSourced, 2023).

Dengan demikian, terdapat peluang penelitian untuk mengembangkan platform yang secara khusus mempertemukan mahasiswa dan alumni muda berdasarkan minat, keahlian, dan tujuan kolaborasi. Penelitian ini memposisikan diri dalam gap research tersebut.
