...
\addbibresource{PropsalTA_AhmadFawwazi.bib}
...
\begin{center}
    ...
    {\Large\bfseries  PENGEMBANGAN APLIKASI KOLABORASI MAHASISWA: MODUL REKOMENDASI \textit{PEOPLE TO PEOPLE} MENGGUNAKAN \textit{AFFINITY BASED MATCHING}}\\
     \vspace{4cm}
